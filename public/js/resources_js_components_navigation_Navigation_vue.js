      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get("users").then(function (response) {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    staticClass: "white--text"
  }, [_vm._v("\n                            " + _vm._s(_vm.user.email) + "\n                        ")])], 1)], 1)], 1), _vm._v(" "), _c("v-divider"), _vm._v(" "), _c("v-list", _vm._l(_vm.items, function (item) {
...
var render = function render() {
  ...
  }, [_c("v-spacer"), _vm._v(" "), _vm.user.is_admin == true ? _c("v-menu", {
    attrs: {
  ...
  }, [_vm._v("mdi-lock")])], 1)], 1)], 1) : _vm._e()], 1);
};
var staticRenderFns = [];
render._withStripped = true;
