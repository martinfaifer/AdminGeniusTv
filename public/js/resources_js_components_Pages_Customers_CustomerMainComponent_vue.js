...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    openPairedDevicesDialog: function openPairedDevicesDialog(pairedDevices) {
    ...
    loadSubscriptionStbAccountCodeData: function loadSubscriptionStbAccountCodeData(subscriptionStbAccountCode) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("nangu/customer/stbAccount/" + subscriptionStbAccountCode).then(function (response) {
        _this2.detailedData = response.data.data;
        _this2.$store.state.alerts = response.data;
        _this2.subscriptionStbAccountCodeDialog = true;
      });
    },
    deleteCustomer: function deleteCustomer() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("nangu/customer/" + this.$route.params.customer).then(function (response) {
        ...
        if (response.data.status == "success") {
          _this3.closeDialog();
          _this3.$router.push("/customers/create");
        }
      });
    },
...
var render = function render() {
  ...
  return _c("div", [_c("v-row", [_c("v-col", {
    ...
    return _c("v-col", {
      ...
      staticClass: "font-weight-medium"
    }, [_vm._v("currencyCode:")]), _vm._v("\n                                    " + _vm._s(subscription.currencyCode) + "\n                                ")]), _vm._v(" "), _c("p", [_c("span", {
      staticClass: "font-weight-medium"
    }, [_vm._v("tariffCode:")]), _vm._v("\n                                    " + _vm._s(subscription.tariffCode) + "\n                                    "), _c("v-icon", {
      staticClass: "mx-3",
      staticStyle: {
        cursor: "pointer"
      },
      ...
      staticClass: "font-weight-medium"
    }, [_vm._v("subscriptionState:")]), _vm._v(" "), _c("span", {
      "class": _vm.getTextColor(subscription.subscriptionState)
      ...
      on: {
        click: function click($event) {
          return _vm.openPairedDevicesDialog(subscription.pairedDevices);
        }
      }
  ...
  }), _vm._v(" "), _vm.detailedData.stb ? _c("v-col", {
    attrs: {
      cols: "12",
      sm: "12",
      md: "4",
  ...
  }), _vm._v(" "), _vm.detailedData.identities ? _c("v-col", {
    attrs: {
      cols: "12",
      sm: "12",
      md: "4",
  ...
  }, [!_vm.detailedData.identities.username ? _c("div", _vm._l(_vm.detailedData.identities, function (identity) {
    return _c("div", {
  ...
  }, [_vm._v("mdi-delete")])], 1) : _vm._e()])]) : _vm._e()], 1)], 1)], 1), _vm._v(" "), _c("v-card-actions", [_c("v-spacer"), _vm._v(" "), _c("v-btn", {
    attrs: {
      color: "blue darken-1",
      plain: "",
      outlined: ""
